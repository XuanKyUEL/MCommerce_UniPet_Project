...
public class FragmentPaymentMethod extends Fragment {
    ...
    private DetailCheckoutHelper paymentMethodListener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof DetailCheckoutHelper) {
            paymentMethodListener = (DetailCheckoutHelper) context;
        }
    }
    ...
    private void chooseMethod() {
        ...
        binding.paymentRadio.setOnCheckedChangeListener((group, checkedId) -> {
        ...
        binding.btnChoosePayment.setOnClickListener(v -> requireActivity().getOnBackPressedDispatcher().onBackPressed());
    }
